...
public class WarMemorySummonMonsterArrange
{
	public const int kYRotationType_Fixed = 1;

	public const int kYRotationType_Randon = 2;
	...
	public WarMemorySummonMonsterArrange(WarMemoryMonsterArrange arrange)
	{
		m_arrange = arrange;
	}
