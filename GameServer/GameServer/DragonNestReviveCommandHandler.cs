...
public class DragonNestReviveCommandHandler : InGameCommandHandler<DragonNestReviveCommandBody, DragonNestReviveResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (!currentPlace.dragonNest.IsSafeRevivalWaitingTimeElapsed(fElapsedTime))
		{
		...
		DragonNestReviveResponseBody resBody = new DragonNestReviveResponseBody();
