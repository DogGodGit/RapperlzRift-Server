...
public class WeeklyPresentContributionPointRankingRewardGroup
{
	private int m_nNo;
	...
	private Dictionary<int, WeeklyPresentContributionPointRankingReward> m_rewards = new Dictionary<int, WeeklyPresentContributionPointRankingReward>();
	...
	public Dictionary<int, WeeklyPresentContributionPointRankingReward> rewards => m_rewards;
	...
	public void AddReward(WeeklyPresentContributionPointRankingReward reward)
	{
		if (reward == null)
		{
...
public class WeeklyPresentContributionPointRankingReward
{
	private WeeklyPresentContributionPointRankingRewardGroup m_group;

	private int m_nNo;

	private ItemReward m_itemReward;

	public WeeklyPresentContributionPointRankingRewardGroup group => m_group;

	public int no => m_nNo;

	public ItemReward itemReward => m_itemReward;

	public WeeklyPresentContributionPointRankingReward(WeeklyPresentContributionPointRankingRewardGroup group)
	{
		if (group == null)
		{
