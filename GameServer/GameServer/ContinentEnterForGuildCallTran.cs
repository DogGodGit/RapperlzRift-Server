...
public class ContinentEnterForGuildCallTransmissionParam : PlaceEntranceParam
{
	...
	public ContinentEnterForGuildCallTransmissionParam(Continent continent, int nNationId, Vector3 position, float fRotationY, DateTimeOffset enterTime)
	{
...
public class ContinentEnterForGuildCallTransmissionCommandHandler : InGameCommandHandler<ContinentEnterForGuildCallTransmissionCommandBody, ContinentEnterForGuildCallTransmissionResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (!(m_myHero.placeEntranceParam is ContinentEnterForGuildCallTransmissionParam param))
		{
		...
		lock (targetPlace.syncObject)
		{
			...
			ContinentEnterForGuildCallTransmissionResponseBody resBody = new ContinentEnterForGuildCallTransmissionResponseBody();
