...
public class GoldDungeonReviveCommandHandler : InGameCommandHandler<GoldDungeonReviveCommandBody, GoldDungeonReviveResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (!currentPlace.goldDungeon.IsSafeRevivalWaitingTimeElapsed(fElapsedTime))
		{
		...
		GoldDungeonReviveResponseBody resBody = new GoldDungeonReviveResponseBody();
