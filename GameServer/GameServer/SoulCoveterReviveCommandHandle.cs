...
public class SoulCoveterReviveCommandHandler : InGameCommandHandler<SoulCoveterReviveCommandBody, SoulCoveterReviveResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (!currentPlace.soulCoveter.IsSafeRevivalWaitingTimeElapsed(fElapsedTime))
		{
		...
		SoulCoveterReviveResponseBody resBody = new SoulCoveterReviveResponseBody();
