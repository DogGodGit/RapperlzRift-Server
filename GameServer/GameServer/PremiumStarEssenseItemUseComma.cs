...
public class PremiumStarEssenseItemUseCommandHandler : InGameCommandHandler<PremiumStarEssenseItemUseCommandBody, PremiumStarEssenseItemUseResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (m_usedItem.type.id != 47)
		{
			throw new CommandHandleException(1, "해당 인벤토리슬롯의 아이템은 고급별의정수아이템타입이 아닙니다. nSlotIndex = " + nSlotIndex);
		}
		...
		SaveToDB();
		SaveToLogDB();
		PremiumStarEssenseItemUseResponseBody resBody = new PremiumStarEssenseItemUseResponseBody();
