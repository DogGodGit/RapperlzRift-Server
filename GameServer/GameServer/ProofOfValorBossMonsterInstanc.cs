...
public class ProofOfValorBossMonsterInstance : MonsterInstance
{
	private ProofOfValorBossMonsterArrange m_arrange;

	private ProofOfValorMonsterAttrFactor m_attrFactor;

	public override Monster monster => m_arrange.monsterArrange.monster;

	public override MonsterInstanceType monsterInstanceType => MonsterInstanceType.ProofOfValorBossMonster;

	public ProofOfValorBossMonsterArrange arrange => m_arrange;

	public void Init(ProofOfValorInstance proofOfValorInst, ProofOfValorBossMonsterArrange arrange)
	{
	...
	{
		return new PDProofOfValorBossMonsterInstance();
	}
}
