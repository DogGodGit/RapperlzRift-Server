...
public class ContinentExitForExpDungeonEnterCommandHandler : InGameCommandHandler<ContinentExitForExpDungeonEnterCommandBody, ContinentExitForExpDungeonEnterResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		ExpDungeonDifficulty difficulty = expDungeon.GetDifficulty(nDifficulty);
		if (difficulty == null)
		{
		...
		if (m_myHero.stamina < expDungeon.requiredStamina)
		{
		...
		currentPlace.Exit(m_myHero, isLogOut: false, new ExpDungeonEnterParam(difficulty, currentTime));
		SendResponseOK(null);
	}
}
