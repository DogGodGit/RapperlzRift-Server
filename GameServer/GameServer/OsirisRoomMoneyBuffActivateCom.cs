...
public class OsirisRoomMoneyBuffActivateCommandHandler : InGameCommandHandler<OsirisRoomMoneyBuffActivateCommandBody, OsirisRoomMoneyBuffActivateResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (!(m_myHero.currentPlace is OsirisRoomInstance currentPlace))
		{
		...
		m_myHero.SetOsirisRoomMoneyBuff(moneyBuff, m_currentTime);
		SaveToDB_Log();
		OsirisRoomMoneyBuffActivateResponseBody resBody = new OsirisRoomMoneyBuffActivateResponseBody();
