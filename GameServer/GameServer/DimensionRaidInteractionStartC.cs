...
public class DimensionRaidInteractionStartCommandHandler : InGameCommandHandler<DimensionRaidInteractionStartCommandBody, DimensionRaidInteractionStartResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		{
			throw new CommandHandleException(1, "모든 단계를 완료했습니다.");
		}
		DimensionRaidQuest quest = Resource.instance.dimensionRaidQuest;
		DimensionRaidQuestStep step = quest.GetStep(m_heroQuest.step);
		Npc targetNpc = step.targetNpc;
