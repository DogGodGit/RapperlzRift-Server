...
public class PresentPopularityPointRanking
{
	...
	public PDPresentPopularityPointRanking ToPDRanking()
	{
		PDPresentPopularityPointRanking inst = new PDPresentPopularityPointRanking();
		...
		inst.name = m_sName;
		inst.level = m_nLevel;
		inst.popularityPoint = m_nPopularityPoint;
		return inst;
	}
}
