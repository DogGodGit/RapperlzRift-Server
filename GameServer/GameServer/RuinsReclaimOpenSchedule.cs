...
public class RuinsReclaimOpenSchedule
{
	...
	public RuinsReclaimOpenSchedule(RuinsReclaim ruinsReclaim)
	{
	...
	public void Set(DataRow dr)
	{
		...
		{
			SFLogUtil.Warn(GetType(), "시작시각이 종료시간보다 늦거나 같습니다. m_nId = " + m_nId + ", m_nStartTime = " + m_nStartTime + ", m_nEndTime = " + m_nEndTime);
		}
	}
