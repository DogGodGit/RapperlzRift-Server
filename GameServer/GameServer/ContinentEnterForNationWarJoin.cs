...
public class ContinentEnterForNationWarJoinCommandHandler : InGameCommandHandler<ContinentEnterForNationWarJoinCommandBody, ContinentEnterForNationWarJoinResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (!(m_myHero.placeEntranceParam is ContinentEnterForNationWarJoinParam param))
		{
		...
		lock (targetPlace.syncObject)
		{
			...
			ContinentEnterForNationWarJoinResponseBody resBody = new ContinentEnterForNationWarJoinResponseBody();
...
public class ContinentEnterForNationWarJoinParam : PlaceEntranceParam
{
	...
	public ContinentEnterForNationWarJoinParam(Continent continent, int nNationId, Vector3 position, float fRotationY, DateTimeOffset enterTime)
	{
