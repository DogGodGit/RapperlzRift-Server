...
public class ContinentEnterForNationWarNpcTransmissionParam : PlaceEntranceParam
{
	...
	public ContinentEnterForNationWarNpcTransmissionParam(Continent continent, int nNationId, Vector3 position, float fRotationY, DateTimeOffset enterTime)
	{
...
public class ContinentEnterForNationWarNpcTransmissionCommandHandler : InGameCommandHandler<ContinentEnterForNationWarNpcTransmissionCommandBody, ContinentEnterForNationWarNpcTransmissionResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (!(m_myHero.placeEntranceParam is ContinentEnterForNationWarNpcTransmissionParam param))
		{
		...
		lock (targetPlace.syncObject)
		{
			...
			ContinentEnterForNationWarNpcTransmissionResponseBody resBody = new ContinentEnterForNationWarNpcTransmissionResponseBody();
