...
public class MainQuestDungeonSaftyReviveCommandHandler : InGameCommandHandler<MainQuestDungeonSaftyReviveCommandBody, MainQuestDungeonSaftyReviveResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (!currentPlace.mainQuestDungeon.IsSafeRevivalWaitingTimeElapsed(fElapsedTime))
		{
		...
		MainQuestDungeonSaftyReviveResponseBody resBody = new MainQuestDungeonSaftyReviveResponseBody();
