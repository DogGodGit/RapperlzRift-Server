...
public class Hero : Unit
{
	...
	private void CompleteLogIn_Base(DataRow drHero, DateTimeOffset currentTime)
	{
		...
		m_lastLocation = Resource.instance.GetLocation(Convert.ToInt32(drHero["lastLocationId"]));
		...
		m_previousNation = Resource.instance.GetNation(Convert.ToInt32(drHero["previousNationId"]));
		m_previousContinent = Resource.instance.GetContinent(Convert.ToInt32(drHero["previousContinentId"]));
