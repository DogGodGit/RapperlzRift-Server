...
public class ConsumeEvent
{
	...
	private Dictionary<int, ConsumeEventMission> m_missions = new Dictionary<int, ConsumeEventMission>();
	...
	public void AddMission(ConsumeEventMission mission)
	{
		if (mission == null)
		{
	...
	public ConsumeEventMission GetMission(int nMissionNo)
	{
