...
public class CashProductPurchaseFailCommandHandler : InGameCommandHandler<CashProductPurchaseFailCommandBody, CashProductPurchaseFailResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		m_sFailReason = m_body.failReason;
	...
	private void Process()
	{
		...
		try
		{
			...
			if (UserDac.UpdatePurchase(conn, trans, m_purchaseId, 4, DateTimeUtil.currentTime, m_sFailReason) != 0)
			{
