...
public class TradeShipReviveCommandHandler : InGameCommandHandler<TradeShipReviveCommandBody, TradeShipReviveResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (!currentPlace.tradeShip.IsSafeRevivalWaitingTimeElapsed(fElapsedTime))
		{
		...
		SaveToDB();
		SaveToDB_Log();
		TradeShipReviveResponseBody resBody = new TradeShipReviveResponseBody();
