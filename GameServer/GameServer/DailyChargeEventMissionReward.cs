...
public class DailyChargeEventMissionReward
{
	...
	public DailyChargeEventMission mission => m_mission;

	public int no => m_nNo;

	public ItemReward itemReward => m_itemReward;

	public DailyChargeEventMissionReward(DailyChargeEventMission mission)
	{
		if (mission == null)
		{
