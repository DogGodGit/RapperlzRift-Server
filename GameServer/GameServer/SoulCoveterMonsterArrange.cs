...
public class SoulCoveterMonsterArrange
{
	...
	public SoulCoveter soulCoveter => m_wave.soulCoveter;

	public SoulCoveterDifficulty difficulty => m_wave.difficulty;

	public SoulCoveterDifficultyWave wave => m_wave;
	...
	public SoulCoveterMonsterArrange(SoulCoveterDifficultyWave wave)
	{
		m_wave = wave;
	}
	...
	public void Set(DataRow dr)
	{
		...
		{
			SFLogUtil.Warn(GetType(), "몬스터수가 유효하지 않습니다. difficulty = " + difficulty.difficulty + ", waveNo = " + wave.no + ", m_nNo = " + m_nNo + ", m_nMonsterCount = " + m_nMonsterCount);
		}
		...
		if (m_fRadius < 0f)
		{
			SFLogUtil.Warn(GetType(), "반지름이 유효하지 않습니다. difficulty = " + difficulty.difficulty + ", waveNo = " + wave.no + ", m_nNo = " + m_nNo + ", m_fRadius = " + m_fRadius);
		}
