...
public class GuildSupplySupportQuestReward
{
	...
	public GuildSupplySupportQuestReward(GuildSupplySupportQuest quest)
	{
		m_quest = quest;
	}
	...
	public void Set(DataRow dr)
	{
		...
		{
			SFLogUtil.Warn(GetType(), "경험치보상ID가 유효하지 않습니다. lnExpRewardId = " + lnExpRewardId);
		}
	}
}
