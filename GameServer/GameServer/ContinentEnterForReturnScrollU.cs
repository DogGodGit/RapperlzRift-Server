...
public class ContinentEnterForReturnScrollUseCommandHandler : InGameCommandHandler<ContinentEnterForReturnScrollUseCommandBody, ContinentEnterForReturnScrollUseResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		if (!(m_myHero.placeEntranceParam is ContinentEnterForReturnScrollUseParam param))
		{
		...
		lock (targetPlace.syncObject)
		{
			...
			ContinentEnterForReturnScrollUseResponseBody resBody = new ContinentEnterForReturnScrollUseResponseBody();
...
public class ContinentEnterForReturnScrollUseParam : PlaceEntranceParam
{
	...
	public ContinentEnterForReturnScrollUseParam(Continent continent, int nNationId, Vector3 position, float fRotationY)
	{
