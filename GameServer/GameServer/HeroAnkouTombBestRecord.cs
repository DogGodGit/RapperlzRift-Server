...
public class HeroAnkouTombBestRecord
{
	...
	public void Init(HeroAnkouTombPoint heroPoint)
	{
		if (heroPoint == null)
		{
	...
	public PDHeroAnkouTombBestRecord ToPDHeroAnkouTombBestRecord()
	{
		PDHeroAnkouTombBestRecord inst = new PDHeroAnkouTombBestRecord();
