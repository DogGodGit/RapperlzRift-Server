...
public class TradeShipMoneyBuffActivateCommandHandler : InGameCommandHandler<TradeShipMoneyBuffActivateCommandBody, TradeShipMoneyBuffActivateResponseBody>
{
	...
	protected override void HandleInGameCommand()
	{
		...
		m_myHero.SetTradeShipMoneyBuff(moneyBuff, m_currentTime);
		SaveToDB();
		SaveToDB_Log();
		TradeShipMoneyBuffActivateResponseBody resBody = new TradeShipMoneyBuffActivateResponseBody();
