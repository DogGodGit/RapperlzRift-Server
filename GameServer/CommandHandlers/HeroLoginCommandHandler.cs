...
public class HeroLoginCommandHandler : LobbyCommandHandler<HeroLoginCommandBody, HeroLoginResponseBody>
{
    ...
    private void CompleteLogIn()
    {
        ...
        resBody.time = m_currentTime;
        resBody.date = m_currentDate;
        resBody.serverOpenDate = Cache.instance.serverOpenDate;
        ...
        resBody.rankRewardReceivedDate = m_hero.rankRewardReceivedDate;
        resBody.rankRewardReceivedRankNo = m_hero.rankRewardReceivedRankNo;
        resBody.mainGears = m_hero.GetPDFullHeroMainGears().ToArray();
        resBody.equippedWeaponId = m_hero.equippedWeapon != null ? m_hero.equippedWeapon.id : Guid.Empty;
        resBody.equippedArmorId = m_hero.equippedArmor != null ? m_hero.equippedArmor.id : Guid.Empty;
        ...
        resBody.receivedAttendRewardDate = m_hero.dailyAttendReawrdDay.date;
        ...
        resBody.guildDailyRewardReceivedDate = m_hero.guildDailyRewardReceivedDate;
        ...
        resBody.receivedGuildFoodWarehouseCollectionId = m_hero.receivedGuildFoodWarehouseCollectionId;
        ...
        resBody.guildAltarRewardReceivedDate = m_hero.guildAltarRewardReceivedDate;
        ...
        resBody.guildHuntingDonationDate = m_hero.guildHuntingDonationDate;
        resBody.guildHuntingDonationRewardReceivedDate = m_hero.guildHuntingDonationCompletionRewardReceivedDate;
        resBody.guildDailyObjectiveRewardReceivedNo = m_hero.receivedGuildDailyObjectiveRewardNo.value;
        resBody.guildWeeklyObjectiveRewardReceivedDate = m_hero.guildWeeklyObjectiveRewardReceivedDate;
        ...
        resBody.illustratedBookExplorationStepRewardReceivedDate = m_hero.illustratedBookExplorationStepRewardReceivedDate;
        ...
        resBody.regDate = m_hero.regTime.Date;
        ...
        resBody.participatedCreatureId = m_hero.participationCreatureId;
