...
public class ArtifactRoomExitCommandHandler : InGameCommandHandler<ArtifactRoomExitCommandBody, ArtifactRoomExitResponseBody>
{
    ...
    protected override void HandleInGameCommand()
    {
        ...
        ArtifactRoomExitResponseBody resBody = new ArtifactRoomExitResponseBody();
