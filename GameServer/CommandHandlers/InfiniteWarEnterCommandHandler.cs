...
public class InfiniteWarEnterCommandHandler : InGameCommandHandler<InfiniteWarEnterCommandBody, InfiniteWarEnterResponseBody>
{
    ...
    protected override void HandleInGameCommand()
    {
        ...
        lock (m_infiniteWarInst.syncObject)
        {
            ...
            resBody.placeInstanceId = m_infiniteWarInst.instanceId;
    ...
    private void SaveToDB_Log()
    {
        try
        {
            ...
            logWork.AddSqlCommand(GameLogDac.CSC_AddInfiniteWarMemberLog(m_infiniteWarInst.instanceId, m_myHero.id, hero.level));
            logWork.Schedule();
        }
        catch (Exception ex)
        {
