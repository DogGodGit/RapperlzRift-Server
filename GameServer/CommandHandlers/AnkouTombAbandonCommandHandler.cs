...
public class AnkouTombAbandonCommandHandler : InGameCommandHandler<AnkouTombAbandonCommandBody, AnkouTombAbandonResponseBody>
{
    ...
    protected override void HandleInGameCommand()
    {
        ...
        AnkouTombAbandonResponseBody resBody = new AnkouTombAbandonResponseBody();
