...
public class CreatureComposeCommandHandler : InGameCommandHandler<CreatureComposeCommandBody, CreatureComposeResponseBody>
{
    ...
    protected override void HandleInGameCommand()
    {
        ...
        Guid mainInstanceId = m_body.mainInstanceId;
        Guid materialInstanceId = m_body.materialInstanceId;
        ...
        lnTotalMaterialCreatueExp = (long)(lnTotalMaterialCreatueExp * Resource.instance.creatureReleaseExpRetrievalRate / 10000f);
