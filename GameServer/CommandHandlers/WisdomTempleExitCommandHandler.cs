...
public class WisdomTempleExitCommandHandler : InGameCommandHandler<WisdomTempleExitCommandBody, WisdomTempleExitResponseBody>
{
    ...
    protected override void HandleInGameCommand()
    {
        ...
        WisdomTempleExitResponseBody resBody = new WisdomTempleExitResponseBody();
