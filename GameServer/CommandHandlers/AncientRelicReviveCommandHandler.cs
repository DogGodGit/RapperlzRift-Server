...
public class AncientRelicReviveCommandHandler : InGameCommandHandler<AncientRelicReviveCommandBody, AncientRelicReviveResponseBody>
{
    ...
    protected override void HandleInGameCommand()
    {
        ...
        if (!currentPlace.ancientRelic.IsSafeRevivalWaitingTimeElapsed(fElapsedTime))
        {
        ...
        AncientRelicReviveResponseBody resBody = new AncientRelicReviveResponseBody();
