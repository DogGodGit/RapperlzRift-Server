...
public class FearAltarReviveCommandHandler : InGameCommandHandler<FearAltarReviveCommandBody, FearAltarReviveResponseBody>
{
    ...
    {
        if (!(m_myHero.currentPlace is FearAltarInstance currentPlace))
        {
        ...
        if (!currentPlace.fearAltar.IsSafeRevivalWaitingTimeElapsed(fElapsedTime))
        {
        ...
        FearAltarReviveResponseBody resBody = new FearAltarReviveResponseBody();
