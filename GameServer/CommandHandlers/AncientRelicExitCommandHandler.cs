...
public class AncientRelicExitCommandHandler : InGameCommandHandler<AncientRelicExitCommandBody, AncientRelicExitResponseBody>
{
    ...
    protected override void HandleInGameCommand()
    {
        ...
        AncientRelicExitResponseBody resBody = new AncientRelicExitResponseBody();
