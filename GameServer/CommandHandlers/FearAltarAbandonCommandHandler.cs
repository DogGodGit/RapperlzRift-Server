...
public class FearAltarAbandonCommandHandler : InGameCommandHandler<FearAltarAbandonCommandBody, FearAltarAbandonResponseBody>
{
    ...
    protected override void HandleInGameCommand()
    {
        ...
        FearAltarAbandonResponseBody resBody = new FearAltarAbandonResponseBody();
