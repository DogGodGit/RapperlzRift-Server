...
public class ProofOfValorExitCommandHandler : InGameCommandHandler<ProofOfValorExitCommandBody, ProofOfValorExitResponseBody>
{
    ...
    protected override void HandleInGameCommand()
    {
        ...
        ProofOfValorExitResponseBody resBody = new ProofOfValorExitResponseBody();
