...
public class ExpDungeonReviveCommandHandler : InGameCommandHandler<ExpDungeonReviveCommandBody, ExpDungeonReviveResponseBody>
{
    ...
    {
        if (!(m_myHero.currentPlace is ExpDungeonInstance currentPlace))
        {
        ...
        if (!currentPlace.expDungeon.IsSafeRevivalWaitingTimeElapsed(fElapsedTime))
        {
        ...
        ExpDungeonReviveResponseBody resBody = new ExpDungeonReviveResponseBody();
