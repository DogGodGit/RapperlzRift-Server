...
public abstract class SFS2SOutboundPeer : OutboundS2SPeer, ISFS2SPeer, ISFPeer
{
	...
	public SFS2SOutboundPeer(ApplicationBase application, ISFHandlerFactory<short, ISFCommandHandler> commandHandlerFactory, ISFHandlerFactory<short, ISFEventHandler> eventHandlerFactory)
		: base(application)
	{
