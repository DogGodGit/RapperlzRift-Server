...
public class CEBMainQuestTransformationMonsterSkillCastEventBody : CEBClientEventBody
{
...
public class CEBMainQuestTransformationMonsterSkillHitEventBody : CEBClientEventBody
{
	public Guid placeInstanceId;
